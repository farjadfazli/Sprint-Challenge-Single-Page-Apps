...
> Answer: With client-side routing the browser/web app can render state changes more efficiently instead of downloading a new page each time.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: A controlled component is one in which form data is handled by the React component itself instead of the browser/DOM.
